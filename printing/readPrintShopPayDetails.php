...
if ($requestMethod === 'GET') {
    ...
    if(isset($_GET['PrtShopId']))
    {        
        $shopParam = $_GET;
        echo getPrintShopPaymentDetails($shopParam); // safer: tie shop to user
        //echo getShopById($shopParam, $userData['uid']);
    }
    
    else 
    {
        echo "Please Enter Print Shop ID"; // return shops for this user only
