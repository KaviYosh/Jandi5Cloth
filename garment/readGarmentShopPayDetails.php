...
if ($requestMethod === 'GET') {
    ...
    if (isset($_GET['GartShopId'])) {        
        $shopParam = $_GET;
        echo getGrtShopPayDetailsById($shopParam); // safer: tie shop to user
        //echo getShopById($shopParam, $userData['uid']);
   
    }
    else 
    {
        echo "Please enter a valid Garment Shop ID"; // return shops for this user only
